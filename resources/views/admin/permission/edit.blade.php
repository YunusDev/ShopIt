            ...
            <div class="col-12">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3 class="card-title"><b>Edit Permission - </b><i>{{$permission->name}}</i></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="col-lg-6">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <select  class="form-control" name="for" id="for">
                                        ...
                                        <option value="user" {{$permission->for == 'user' ? 'selected' : 'ntn'}}>User</option>
                                        <option value="product" {{$permission->for == 'product' ? 'selected' : 'ntn'}}>Product</option>
                                        <option value="other" {{$permission->for == 'other' ? 'selected' : 'ntn'}}>Other</option>
